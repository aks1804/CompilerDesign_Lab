...
string_initilization
			: assignment_operator string_constant {insert_value();} ;
...
constant
			: integer_constant 	{  insert_value(); codegencon(); $$=1; }
			| string_constant	{  insert_value(); codegencon();$$=-1;}
			| float_constant	{  insert_value(); codegencon();}
			| character_constant{  insert_value(); codegencon();$$=1; };
